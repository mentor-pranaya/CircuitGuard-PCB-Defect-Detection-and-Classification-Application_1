...
Access the app: Browser opens automatically at http://localhost:8501
...
Or use: models/best_efficientnet_model.pth

Step 2: Enter the path in sidebar

Type the correct path if different from default
Example: models/my_model.pkl
